...
executorLabel.Size = UDim2.new(1, -40, 0, 25)
executorLabel.Position = UDim2.new(0, 20, 0, 85)
...
runtimeLabel.Position = UDim2.new(0, 20, 0, 215)
...
-- Tracers
local tracerBtn = makeVisualBtn("Tracers: OFF", UDim2.new(0, 20, 0, 155))
local tracerLines = {}
...
tracerBtn.MouseButton1Click:Connect(function()
	if not DrawingAvailable then
		tracerBtn.Text = "Tracers: Not Supported"
		return
	end
...
rangeLabel.Size = UDim2.new(0, 250, 0, 25)
rangeLabel.Position = UDim2.new(0, 20, 0, 65)
rangeLabel.BackgroundTransparency = 1
rangeLabel.Text = "Tracer Range: " .. tracerRange
...
colorBtn("Tracer Colour", tracerColor, 110, function(c) tracerColor = c end)
colorBtn("Highlight Colour", highlightColor, 155, function(c) highlightColor = c end)
colorBtn("Name Tag Colour", nameTagColor, 200, function(c) nameTagColor = c end)
...
local execCred = Instance.new("TextLabel")
execCred.Size = UDim2.new(1, -40, 0, 25)
execCred.Position = UDim2.new(0, 20, 0, 105)
execCred.BackgroundTransparency = 1
execCred.Text = "Running on: " .. executorName
execCred.TextColor3 = Color3.fromRGB(0, 170, 255)
execCred.Font = Enum.Font.GothamBold
execCred.TextSize = 16
execCred.TextXAlignment = Enum.TextXAlignment.Left
execCred.Parent = Credits
...
print("[Modern Hub] Loaded successfully on " .. executorName)
