...
description.Text =
	"Press Get Started to unlock features"
...
getStarted.Position =
	UDim2.new(.5,-90,0,190)


getStarted.BackgroundColor3 =
...
Instance.new("UICorner",getStarted)
.CornerRadius =
	UDim.new(0,12)
...
tutorialArrow.TextColor3 =
	Color3.fromRGB(0,170,255)


tutorialArrow.TextSize =
	35
...
Instance.new("UICorner",tutorialText)
.CornerRadius =
	UDim.new(0,10)
    -------------------------------------------------
...
Instance.new("UICorner",teleport)
.CornerRadius =
	UDim.new(0,8)
...
getCoords.BackgroundColor3 =
	Color3.fromRGB(50,50,50)


getCoords.TextColor3 =
	Color3.new(1,1,1)
...
Instance.new("UICorner",getCoords)
.CornerRadius =
	UDim.new(0,8)
...
copyCoords.BackgroundColor3 =
	Color3.fromRGB(50,50,50)


copyCoords.TextColor3 =
	Color3.new(1,1,1)
...
Instance.new("UICorner",copyCoords)
.CornerRadius =
	UDim.new(0,8)
...
flySpeedBox.Position =
	UDim2.new(0,20,0,310)
...
flySpeedBox.BackgroundColor3 =
	Color3.fromRGB(50,50,50)


flySpeedBox.TextColor3 =
	Color3.new(1,1,1)
...
getStarted.MouseButton1Click:Connect(function()
	...
	tutorial(
		playerButton,
		"Player: Speed, teleport and flying."
	)
	...
	tutorial(
		visualsButton,
		"Visuals: Player visuals and performance."
	)
	...
	tutorial(
		miscButton,
		"Misc: Extra tools and utilities."
	)
...
visualsTitle.TextSize =
	26


visualsTitle.TextXAlignment =
	Enum.TextXAlignment.Left
...
local function addName(plr)
	...
	and not plr.Character.Head:FindFirstChild(
		"ModernHubName"
	) then
...
tracerLabel.Text =
	"Tracer Range: "..tracerRange


tracerLabel.TextColor3 =
	Color3.new(1,1,1)
...
tracerLabel.TextSize =
	18


tracerLabel.TextXAlignment =
	Enum.TextXAlignment.Left
...
Instance.new("UICorner",tracerBar)
.CornerRadius =
	UDim.new(1,0)
...
Instance.new("UICorner",tracerFill)
.CornerRadius =
	UDim.new(1,0)
...
Instance.new("UICorner",tracerKnob)
.CornerRadius =
	UDim.new(1,0)
	...
	and input.UserInputType ==
		...
		local percent =
			math.clamp(
				(
					input.Position.X -
					tracerBar.AbsolutePosition.X
				)
				/
				tracerBar.AbsoluteSize.X,
				0,
				1
			)
...
creditsTitle.TextSize =
	28


creditsTitle.TextXAlignment =
	Enum.TextXAlignment.Left
...
creatorText.Text =
	"Made by Linux_Fan1248970"


creatorText.TextColor3 =
	Color3.fromRGB(
		230,230,230
	)
...
creatorText.TextSize =
	20


creatorText.TextXAlignment =
	Enum.TextXAlignment.Left
...
Instance.new("UICorner",tiktokCard)
.CornerRadius =
	UDim.new(0,12)
...
tiktokCard.MouseButton1Click:Connect(function()
	...
	if setclipboard then
		...
		setclipboard(
			"https://www.tiktok.com/@linux_fan1248970"
		)
...
distanceKnob.Position =
	UDim2.new(.25,-10,.5,-10)


distanceKnob.Text = ""


distanceKnob.BackgroundColor3 =
	Color3.new(1,1,1)
	...
	and input.UserInputType ==
		...
		local percent =
			math.clamp(
				(
					input.Position.X -
					distanceBar.AbsolutePosition.X
				)
				/
				distanceBar.AbsoluteSize.X,
				0,
				1
			)
...
orbitButton.Position =
	UDim2.new(0,20,0,420)
...
Instance.new("UICorner",orbitButton)
.CornerRadius =
	UDim.new(0,8)
...
spectateButton.Position =
	UDim2.new(0,20,0,480)
...
saveWaypoint.BackgroundColor3 =
	Color3.fromRGB(
		50,50,50
	)


saveWaypoint.TextColor3 =
	Color3.new(1,1,1)
...
tpWaypoint.BackgroundColor3 =
	Color3.fromRGB(
		50,50,50
	)


tpWaypoint.TextColor3 =
	Color3.new(1,1,1)
...
shakeButton.Position =
	UDim2.new(0,300,0,540)
...
rgbButton.BackgroundColor3 =
	Color3.fromRGB(
		50,50,50
	)


rgbButton.TextColor3 =
	Color3.new(1,1,1)
...
local partSpawnerTitle =
	Instance.new("TextLabel")


partSpawnerTitle.Size =
	UDim2.new(0,250,0,30)


partSpawnerTitle.Position =
	UDim2.new(0,470,0,520)


partSpawnerTitle.BackgroundTransparency = 1


partSpawnerTitle.Text =
	"Part Spawner"


partSpawnerTitle.TextColor3 =
	Color3.new(1,1,1)


partSpawnerTitle.Font =
	Enum.Font.GothamBold


partSpawnerTitle.TextSize =
	20


partSpawnerTitle.TextXAlignment =
	Enum.TextXAlignment.Left


partSpawnerTitle.Parent =
	Misc



local spawnPartButton =
	Instance.new("TextButton")


spawnPartButton.Size =
	UDim2.new(0,140,0,35)


spawnPartButton.Position =
	UDim2.new(0,470,0,570)


spawnPartButton.BackgroundColor3 =
	Color3.fromRGB(
		0,170,255
	)


spawnPartButton.Text =
	"Spawn Part"


spawnPartButton.TextColor3 =
	Color3.new(1,1,1)


spawnPartButton.Font =
	Enum.Font.GothamBold


spawnPartButton.TextSize =
	16


spawnPartButton.Parent =
	Misc



Instance.new("UICorner",spawnPartButton)
.CornerRadius =
	UDim.new(0,8)
...
local deletePartsButton =
	Instance.new("TextButton")


deletePartsButton.Size =
	UDim2.new(0,140,0,35)


deletePartsButton.Position =
	UDim2.new(0,620,0,570)


deletePartsButton.BackgroundColor3 =
	Color3.fromRGB(
		200,60,60
	)


deletePartsButton.Text =
	"Delete Parts"


deletePartsButton.TextColor3 =
	Color3.new(1,1,1)


deletePartsButton.Parent =
	Misc



Instance.new("UICorner",deletePartsButton)
.CornerRadius =
	UDim.new(0,8)
